...
public class NoteFragment2 extends Fragment {
    public static final String NAME = NoteFragment2.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.note_fragment2, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        note_title = view.findViewById(R.id.note_title_frag2);
        description = view.findViewById(R.id.excerpt_frag2);

        // Stores shared preference values into local variable
        fragmentData = this.getActivity().getSharedPreferences("Fragment2", Context.MODE_PRIVATE);
        note_title_value = fragmentData.getString("NOTE_TITLE","Note 2");
        ...
        fragment_layout.setOnClickListener(v -> {
            ...
            EventBus.getDefault().post(new OnNoteEvent(noteModel_fragment, 2));
    ...
    public void onEventBusEvent(OnNoteUpdatedEvent event) {
        if (event.noteModelPosition == 2) {
            ...
            this.getActivity().getSharedPreferences("Fragment2", Context.MODE_PRIVATE)
                    .edit()
